...
/**
 * Play Store flavor — uses the Google Play Integrity API to verify the
 * device and app package have not been tampered with.
 *
 * This class is compiled ONLY for the "play" product flavor.
 * For the "amazon" flavor, see src/amazon/.../security/IntegrityCheck.kt
 */
