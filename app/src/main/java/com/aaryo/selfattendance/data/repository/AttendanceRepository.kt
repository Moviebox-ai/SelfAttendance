...
class AttendanceRepository {
     ...
     *
     * BUG FIX: Previously swallowed all exceptions, so callers (CalendarViewModel)
    ...
    suspend fun deleteAttendance(
        ...
        try {
            ...
            // BUG FIX: previously this exception was only logged, never rethrown,
    ...
    suspend fun deleteAllAttendance(uid: String) {
        ...
        try {
            ...
            // BUG FIX: Firestore batch limit 500 hai. Pehle single batch mein sab
