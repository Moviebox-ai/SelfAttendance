...
class HourlyReminderWorker(
    ...
    companion object {
        ...
        private val MARK_ATTENDANCE_MESSAGES = listOf(
            Pair("📋 Daily Attendance Reminder", "Mark your attendance to keep your salary and work calculations accurate."),
            Pair("⏳ Attendance Pending", "Today's attendance has not been marked yet. Tap to update."),
            Pair("✅ Attendance Check", "Mark your daily attendance and working hours with a single tap."),
            Pair("📊 Salary & Attendance Record", "Update your work record to ensure accurate monthly salary calculations."),
            Pair("🔥 Daily Attendance Streak", "Keep your regular attendance streak going. Mark your attendance now.")
        )
    }
