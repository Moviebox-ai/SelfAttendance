...
/**
 * Composable that renders the standard adaptive banner ad via [AdsController].
 */
@Composable
fun BannerAdComposable(modifier: androidx.compose.ui.Modifier = androidx.compose.ui.Modifier) {
    AdsController.BannerAdView(modifier = modifier)
}
