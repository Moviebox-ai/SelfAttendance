...
class CalendarViewModel(
    ...
    // BUG FIX: Previously, a Firestore write failure was silently swallowed.
    ...
    private fun loadProfileAndAttendance() {
        viewModelScope.launch {
            ...
            // BUG FIX: Wrapped in try/catch. Previously, a Firebase error in
    ...
    fun selectDate(date: String) {
        // BUG FIX: LocalDate.parse() throws DateTimeParseException on any malformed
     ...
     *
     * BUG FIX: AttendanceRepository.saveOrUpdateAttendance() now re-throws on
