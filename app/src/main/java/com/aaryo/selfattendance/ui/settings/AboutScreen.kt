...
fun AboutScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        // Routes.ABOUT inside MainScreen's NavHost, which already renders a persistent
        // BannerAdView in its own Scaffold bottomBar. Placing another BannerAdView here
        // created two simultaneous AdView instances — an AdMob policy violation —
        // and showed two stacked banners to the user.
    ) { padding ->
    ...
    Box(
        ...
        Column(
            ...
            Surface(
                ...
                Text(
                    text = "Version ${BuildConfig.VERSION_NAME}  ·  Android",
