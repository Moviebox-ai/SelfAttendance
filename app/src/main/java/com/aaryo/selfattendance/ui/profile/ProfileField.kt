...
// BUG FIX: Removed the unused `initial: String = ""` parameter. It was declared
// in the original signature but never read anywhere inside the composable body,
// producing a compiler warning on every call-site that passed a value for it.
// Existing call-sites using named arguments are unaffected; call-sites that
// passed `initial` positionally must remove that argument.
@Composable
fun ProfileField(
    value         : String,
