...
fun MonthlySummaryCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.calendar_monthly_summary),
                style = MaterialTheme.typography.titleMedium
            )

            Spacer(modifier = Modifier.height(16.dp))

            // Attendance row (4 columns)
            ...
            Row(
                ...
                SummaryItem(
                    ...
                    value = "$currencySymbol ${salary.toInt()}",
            ...
            Row(
                ...
                SummaryItem(
                    ...
                    value = "$currencySymbol ${"%.0f".format(perDay)}",
                    color = Color(0xFF00C853)
                )

                SummaryItem(
                    title = stringResource(R.string.summary_per_hour),
                    value = "$currencySymbol ${"%.2f".format(perHour)}",
                    color = Color(0xFFFFB300)
                )
            }
        }
